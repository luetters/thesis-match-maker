      ...
      <div className="grid sm:grid-cols-2 gap-5">
        <div className="sm:col-span-2">
          ...
          <input
            ...
            style={{ "--tw-ring-color": "oklch(38.5% 0.12 152)" } as React.CSSProperties}
          />
        </div>
      ...
      {currentUrl ? (
        <div className="flex items-center gap-2">
          <a
            ...
            style={{ backgroundColor: "oklch(95% 0.03 152)", color: "oklch(38.5% 0.12 152)" }}
          >
...
export default function StudentDashboard() {
  ...
  const [activeTab, setActiveTab] = useState<"overview" | "new" | "requests" | "examiners">(
    location === "/student/new" ? "new" :
    location === "/student/requests" ? "requests" :
    location === "/student/examiners" ? "examiners" : "overview"
  );
