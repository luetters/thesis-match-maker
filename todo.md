...
## Administrative Raum-Sperrzeiten
- [x] Bestehende Raumdaten und mögliche Synchronisationsschnittstellen analysiert (keine aktive Raumplan-Integration konfiguriert)
- [x] Datenmodell und Admin-Prozeduren für Raum-Sperrzeiten implementiert
- [x] Sperrzeiten in die automatische Raum-Konfliktprüfung integriert
- [x] Admin-Oberfläche zum Anlegen, Bearbeiten und Löschen von Sperrzeiten bereitgestellt
- [x] Sperrzeiten und Zeitüberlappungen mit Vitest abgesichert (160 Tests)
