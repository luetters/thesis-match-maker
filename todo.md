...
## Phase 32: Semesterweise-Übersicht für Gutachter:innen

### Backend-Funktionen
- [x] getExaminerSupervisionsBySemester(examinerId, semester) – Betreuungen pro Semester
- [x] Daten: Student:in-Name, Matrikel, Thema, Status, Abschlussart
- [x] Filterung nach Semester (WS2025/26, SoSe2026, etc.)
- [x] Sortierung nach Status (aktiv, abgeschlossen, abgelehnt)

### tRPC-Prozeduren
- [x] examiner.getSupervisionsBySemester – Betreuungen pro Semester abrufen
- [x] examiner.getAllSemesters – Alle Semester mit Betreuungen auflisten
- [x] examiner.getSupervisionStats – Statistiken pro Semester (Anzahl, Abschlussarten)

### Frontend-Komponente
- [x] ExaminerSupervisionsOverview.tsx – Hauptkomponente mit Semester-Tabs
- [x] Semester-Tabs (WS2025/26, SoSe2026, WS2026/27, etc.)
- [x] Betreuungs-Tabelle mit Spalten: Name, Matrikel, Thema, Abschlussart, Status
